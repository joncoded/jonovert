...
export default function About() {
  return ( 
    <MainDiv>
      ...
      <p>The "minimal viable product" is complete!</p>
      
      <p>I will <Link href="https://github.com/joncoded/jonovert/commits/master">report more conversion data</Link> when time permits!</p>
